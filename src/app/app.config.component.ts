      ...
      <div class="layout-themes">
        <div *ngFor="let topbarColor of topbarColors">
          <a
            ...
            [ngStyle]="{ 'background-color': topbarColor.color }"
          >
            <i
              class="pi pi-check"
              *ngIf="app.topbarColor === topbarColor.label"
              [ngStyle]="{
                color: topbarColor.logo === 'logo-olympia' ? '#333333' : ''
              }"
            ></i>
          </a>
        </div>
